      ...
      <Grid item xs={12} md={10}>
        <Paper elevation={0} sx={{ backgroundColor: 'inherit' }} >
          <Box py={3} px={4}>
            ...
            Если бы менеджер <b>знал</b>, как общаться с кассиром, то можно было бы <b>избежать</b> потери клиентов, 
            ...
            Если же <b>подобрать подходящего человека</b>, который легко находит общий язык со всеми, 
            "умеет воспринимать жизнь с позитивной стороны и мотивировать окружающих делать то же самое",
          ...
          <Paper elevation={4} sx={{ backgroundColor: '#3a6ea5', height: '100%', position: 'relative', display:'flex' }}>
            <Box py={3} px={4}>
              ...
              <Typography variant="body1" gutterBottom sx={{ color: 'white' }}>
                ...
                <b>4.</b> Результаты теста будут видны в личном кабинете в виде таблицы. Там будет общее <b>описание психотипа соискателя, сильные и слабые стороны, подходящие профессии.</b><br /><br />
              </Typography>
