...
<form class="yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8" >
    ...
    <div class="ym-payment-btn-block">
        ...
        <button data-text="Скачать" class="ym-btn-pay ym-result-price"><span class="ym-text-crop">Скачать</span> <span class="ym-price-output"> 99,00&nbsp;₽</span>
        </button><svg class="ym-logo" width="114" height="27" viewBox="0 0 114 27" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="logoTitle" role="img">
...
<input name="shopId" type="hidden" value="210416"></form>
    ...
    return (
        <React.Fragment>
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell align="right"><YourComponent /></TableCell>
